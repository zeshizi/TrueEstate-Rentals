...
const sampleProperties = [
  ...
  // Additional properties for major states to increase density
  // California - Additional properties
  {
    id: "prop_california_3",
    address: "1234 Silicon Valley Tech Estate",
    city: "Palo Alto",
    state: "CA",
    zipCode: "94301",
    value: 22000000,
    ...
    sqft: 20000,
    yearBuilt: 2021,
    images: ["/placeholder.svg?height=300&width=400&text=Silicon+Valley+Estate"],
  ...
  },
  {
    ...
    address: "567 Napa Valley Vineyard Estate",
    city: "Napa",
    state: "CA",
    zipCode: "94558",
    value: 18500000,
    ...
    features: ["Vineyard", "Wine Cellar", "Tasting Room", "Guest House"],
    isActive: true,
    dataSource: "sample",
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  {
    id: "prop_california_5",
    address: "890 San Francisco Pacific Heights",
    city: "San Francisco",
    state: "CA",
    zipCode: "94115",
    value: 16800000,
    ...
    sqft: 12000,
    yearBuilt: 1920,
    images: ["/placeholder.svg?height=300&width=400&text=San+Francisco+Mansion"],
    features: ["Bay Views", "Historic", "Wine Cellar", "Rooftop Deck"],
    isActive: true,
    dataSource: "sample",
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  // New York - Additional properties
  {
    id: "prop_newyork_3",
    address: "789 Fifth Avenue Penthouse",
    city: "New York",
    state: "NY",
    zipCode: "10022",
    value: 32000000,
    ...
    features: ["Central Park Views", "Private Elevator", "Rooftop Terrace", "Concierge"],
    isActive: true,
    dataSource: "sample",
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  {
    id: "prop_newyork_4",
    address: "456 Brooklyn Heights Mansion",
    city: "Brooklyn",
    state: "NY",
    zipCode: "11201",
    value: 8500000,
    ...
    features: ["Manhattan Views", "Historic", "Garden", "Wine Cellar"],
    isActive: true,
    dataSource: "sample",
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  // Texas - Additional properties
  {
    id: "prop_texas_3",
    address: "567 Austin Tech Campus Estate",
    city: "Austin",
    state: "TX",
    zipCode: "78701",
    value: 9800000,
    ...
    sqft: 13000,
    yearBuilt: 2020,
    images: ["/placeholder.svg?height=300&width=400&text=Austin+Tech+Estate"],
    features: ["Smart Home", "Pool", "Home Theater", "Guest House"],
    isActive: true,
    dataSource: "sample",
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  // Florida - Additional properties
  {
    ...
    features: ["Golf Course Views", "Pool", "Wine Cellar", "Guest House"],
    isActive: true,
    dataSource: "sample",
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  {
    id: "prop_florida_3",
    address: "890 Key West Oceanfront Villa",
    city: "Key West",
    state: "FL",
    zipCode: "33040",
    value: 6200000,
    ...
    sqft: 8500,
    yearBuilt: 2018,
    images: ["/placeholder.svg?height=300&width=400&text=Key+West+Villa"],
    features: ["Ocean Views", "Private Beach", "Dock", "Tropical Gardens"],
    isActive: true,
    dataSource: "sample",
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  // Illinois - Additional properties
  {
    id: "prop_illinois_2",
    ...
    features: ["Lake Views", "Pool", "Tennis Court", "Guest House"],
    isActive: true,
    dataSource: "sample",
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  // Massachusetts - Additional properties
  {
    ...
    sqft: 15000,
    yearBuilt: 2016,
    images: ["/placeholder.svg?height=300&width=400&text=Marthas+Vineyard+Estate"],
    features: ["Ocean Views", "Private Beach", "Guest House", "Dock"],
    isActive: true,
    dataSource: "sample",
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  // Washington - Additional properties
  {
    ...
    sqft: 13000,
    yearBuilt: 2020,
    images: ["/placeholder.svg?height=300&width=400&text=Bellevue+Tech+Mansion"],
    features: ["Lake Views", "Smart Home", "Pool", "Home Theater"],
    isActive: true,
    dataSource: "sample",
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  // Additional properties for other major states
  // Arizona - Additional
  {
    id: "prop_arizona_2",
    address: "456 Phoenix Desert Ridge Estate",
    city: "Phoenix",
    state: "AZ",
    zipCode: "85018",
    value: 4800000,
    propertyType: "estate",
    ownerName: "Southwest Holdings Group",
    ownerType: "corporation",
    ownerWealth: 185000000,
    ...
    sqft: 11000,
    yearBuilt: 2019,
    images: ["/placeholder.svg?height=300&width=400&text=Phoenix+Desert+Estate"],
    features: ["Desert Views", "Pool", "Golf Course", "Guest Casita"],
    isActive: true,
    dataSource: "sample",
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  {
    id: "prop_colorado_2",
    address: "321 Vail Ski Resort Estate",
    city: "Vail",
    state: "CO",
    zipCode: "81657",
    value: 12800000,
    ...
    sqft: 14000,
    yearBuilt: 2018,
    images: ["/placeholder.svg?height=300&width=400&text=Vail+Ski+Lodge"],
    features: ["Ski-in/Ski-out", "Mountain Views", "Hot Tub", "Wine Cellar"],
    isActive: true,
    dataSource: "sample",
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  // Georgia - Additional
  {
    ...
    sqft: 9000,
    yearBuilt: 1850,
    images: ["/placeholder.svg?height=300&width=400&text=Savannah+Historic+Mansion"],
    features: ["Historic District", "Courtyard", "Carriage House", "Gardens"],
    isActive: true,
    dataSource: "sample",
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  // Nevada - Additional
  {
    ...
    sqft: 16000,
    yearBuilt: 2020,
    images: ["/placeholder.svg?height=300&width=400&text=Lake+Tahoe+Estate"],
    features: ["Lake Views", "Private Beach", "Dock", "Guest Lodge"],
    isActive: true,
    dataSource: "sample",
    createdAt: new Date(),
    updatedAt: new Date(),
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log("🔍 Properties API - Using comprehensive mock data for all states:", JSON.stringify(filters, null, 2))
    ...
    return NextResponse.json({
      ...
      success: true,
      message: "Using comprehensive mock data for all 50 states + DC",
    })
  } catch (error) {
