...
import { Building2, LogOut, User, Settings, Menu, Bookmark, Eye } from "lucide-react"
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-gray-500 font-medium -mt-1">Transparency in Real Estate</span>
              </div>
            </Link>
          </div>
                ...
                <DropdownMenuContent className="w-56" align="end" forceMount>
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/bookmarks" className="flex items-center text-sm">
                      ...
                      Saved Properties ({bookmarkCount})
                    </Link>
                  </DropdownMenuItem>
